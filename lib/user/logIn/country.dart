  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: Countries.allCountries.length,
        itemBuilder: (context, index) {
          var country = Countries.allCountries[index];
          return ListTile(
            title: Text(country["name"]!),
            subtitle: Text("Dial Code: ${country["dial_code"]}"),
            trailing: Icon(Icons.arrow_forward),
            onTap: () {
              // You can add an action when a country is tapped
