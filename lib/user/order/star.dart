...
class StarRatingWidget2 extends StatefulWidget {
  const StarRatingWidget2({super.key});

  @override
  StarRatingWidgetState createState() => StarRatingWidgetState();
}

class StarRatingWidgetState extends State<StarRatingWidget2>
                ...
                child: ScaleTransition(
                  ...
                  child: Opacity(
                    ...
                    child: Transform.rotate(
                      ...
                      child: Icon(
                        Icons.star,
                        color: isRated ? Colors.yellow[400] : Colors.white,
                        size: 3
